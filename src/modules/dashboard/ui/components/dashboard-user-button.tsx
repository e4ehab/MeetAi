...
export const DashboardUserButton = () => {
    ...
    const onLogout = () => {
        authClient.signOut({
            fetchOptions: {
                onSuccess: () => {
                    router.push("/sign-in"); // Use router.replace() instead if you want to clear history and prevent back navigation
                }
            }
        })
    }
    ...
    return (
        <DropdownMenu>
            ...
            <DropdownMenuContent align="end" side="right" className="w-72"> {/* when you click on user button it will pop up this new options*/}
                ...
                <DropdownMenuItem className="cursor-pointer flext items-center justify-between" onClick={onLogout}>
                    Logout
