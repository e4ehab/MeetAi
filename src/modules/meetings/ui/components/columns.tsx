...
function formatDuration(seconds: number) {
    //This function converts a duration in seconds into a human-readable string (like "5 minutes" or "2 hours").
...
const statusIconMap = {
    //display the icon based on status
...
const statusColorMap = {
    //have specific color for each status
