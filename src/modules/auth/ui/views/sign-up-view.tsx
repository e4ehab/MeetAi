    ...
    .refine((data) => data.password === data.confirmPassword,
        {
            ...
            path: ["confirmPassword"], //what field that will show the error message
        }
    );


export const SignUpView = () => {
    const router = useRouter(); //use router to pust& redirect  after successful sign up without refresing the page
    ...
    const onSocial = (provider: "github" | "google") => {
        ...
        authClient.signIn.social(
            ...
            {
                onSuccess: () => {
                    //no need to redirect here as the social sign in will handle the redirection (router.push("/"))
                    setPending(false);
                },
                onError: ({ error }) => {
                    setError(error.message);
